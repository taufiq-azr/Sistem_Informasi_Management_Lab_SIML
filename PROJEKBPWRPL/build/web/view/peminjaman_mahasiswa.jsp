<%-- 
    Document   : peminjaman
    Created on : Feb 8, 2022, 12:55:23 PM
    Author     : MSIGF63
--%>
                                                        ...
                                                        <table class="table table-borderless table-striped table-earning">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <% if (rs.getString("username").equalsIgnoreCase((String) session.getAttribute("username")) && rs.getString("status").equalsIgnoreCase("diajukan")) {%>
                                                                        <a href="../control/batal_peminjaman.jsp?id_peminjaman=<%=rs.getInt("id_peminjaman")%>">Batal</a> 
                                                                        <%} else if (rs.getString("username").equalsIgnoreCase((String) session.getAttribute("username")) && rs.getString("status").equalsIgnoreCase("selesai")) {%>
                                                                        <a href="../view/form_logbook.jsp?id_peminjaman=<%=rs.getInt("id_peminjaman")%>">Isi LogBook</a> 
                                                                        <%} else  {%>       
                                                                        <a href="#"></a> 
                                                                        <%}%>
                                                                    </td>
