<%-- 
    Document   : kontak
    Created on : Feb 8, 2022, 12:55:59 PM
    Author     : MSIGF63
--%>
                                ...
                                <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                                    ...
                                    <div class="menu-sidebar2__content js-scrollbar2">
                                        <div class="account2">
                                            ...
                                            <a href="../view/UIlogin.jsp">Sign out</a>
                                        </div>
                                        <nav class="navbar-sidebar2">
                                            <ul class="list-unstyled navbar__list">
                                                <li class="active has-sub">
                                                ...
                                                <div class="col-xl-12">
                                                    ...
                                                    <br>
                                                        <h3 class="title-3 m-b-30">
                                                            <center><i><b>Jika ada pertanyaan atau masalah seputar sistem</b></i><br><br>
                                                                <i>silahkan kontak kami di:</i><br>

                                                                Kepala Laboratorium
                                                                R.327 / R.310 - Politeknik Caltex Riau
                                                                Email: ibnu@pcr.ac.id / anggy@pcr.ac.id
                                                                Jl.Umbansari (patin) No.01 Rumbai
                                                                Pekanbaru, Riau</i></h3></center>
