...
<%
    ...
    try {
        ...
        String query = "select*from peminjaman where level_peminjaman =\"level 3\"";
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="edit_peminjaman_pudir.jsp?id_peminjaman=<%=rs.getInt("id_peminjaman")%>">Edit</a>
                                                    </td>
                                                </tr>
                                                <% i++;
                                                                    } %>
