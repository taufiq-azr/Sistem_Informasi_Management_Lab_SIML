                                                            ...
                                                            <div class="card-body card-block">
                                                                <form action="../control/edit_logbook.jsp" method="post">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="no_pc" name="no_pc" value="<%=rs.getString("no_pc")%>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="keterangan" class="form-label">
                                                                            Keterangan
                                                                        </label>
                                                                        <input type="text" class="form-control" id="keterangan" name="keterangan" value="<%=rs.getString("keterangan")%>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
